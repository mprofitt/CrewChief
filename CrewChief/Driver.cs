...
namespace CrewChief
{
    public class Driver
    {
        public Driver()
        {
            RelativeLapDistanceHistory = new List<float>();
        }
        /// <summary>
        ...
        /// <summary>
        /// Used to determine if a driver TrackSurface changes
        /// </summary>
        public TrackSurfaces LastTrackSurface { get; set; }
        ...
        /// <summary>
        /// The distance from the driver to your location (in percentage)
        /// </summary>
        public float Distance { get; set; }

        /// <summary>
        /// The driver is on pit road
        /// </summary>
        public bool OnPitRoad { get; set; }

        /// <summary>
        /// The relative distance between you and this driver (in seconds).
        /// </summary>
        /// 
        public float RelativeToMe { get; set; }
        ...
        /// <summary>
        /// The previous relative distance between you and this driver (in percentage).
        /// </summary>
        /// 
        public List<float> RelativeLapDistanceHistory;
        ...
        /// <summary>
        /// The estimate time to current location
        /// </summary>
        ...
        /// <summary>
        /// Is the driver in his car
        /// </summary>
        public bool IsOnTrack { get; set; }

        /// <summary>
        /// The position of drivers pit stall
        /// </summary>
        public float PitPos { get; set; }
        public static IEnumerable<Driver> Drivers { get; internal set; }
